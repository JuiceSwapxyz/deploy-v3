...
// Source: https://github.com/Uniswap/v3-core/blob/v1.0.0/contracts/UniswapV3Pool.sol
// Changes:
//   1. Lines 848-849: Protocol fee maximum changed from 4 (25% max) to 2 (50% max)
//      - Old: (feeProtocol0 >= 4 && feeProtocol0 <= 10)
//      - New: (feeProtocol0 >= 2 && feeProtocol0 <= 10)
//   2. Most import paths changed to @uniswap/v3-core package imports (except line 15: './NoDelegateCall.sol')
